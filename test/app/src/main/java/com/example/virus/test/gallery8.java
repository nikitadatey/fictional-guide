...
public class gallery8 extends AppCompatActivity {
    ...
    int[] pimg_article = new int[]{
            R.drawable.kudremukh1,
            R.drawable.kudremukh2,
            R.drawable.kudremukh3,
            R.drawable.kudremukh4,
            R.drawable.kudremukh5,
            R.drawable.kudremukh6,
            R.drawable.kudremukh7,
            R.drawable.kudremukh8
    };
